...
def visualize_generated_samples(model,dataloader,device,epoch,save_dir,num_samples=3):
    model.eval()
    ...
    with torch.no_grad():
        ...
        # random target modality
        target_modality_id = random.randint(0, 3)
        ...
        outputs = model(
            x_dict=x_dict,
            x_target_gt=None,  # inference-like
